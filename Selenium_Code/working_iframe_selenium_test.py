...
# https://campaign-manager.stage.zefr.com/iob/view-io/293/633
...
#        self.driver.maximize_window()
    ...
    # working test: How to scroll to hidden value- chris
    def test_scroll_horizontally(self):
        try:
           ...
           myele = driver.find_elements(By.XPATH, "//*[@data-name='iob-io-details-plan-tab']")
           print("myele = {}".format(myele))
           newele = myele[1] 
           newele.click()
           time.sleep(2)
...
#           self.assertIn("Zefr Accounts | Login", driver.title)
           ...
           # Verify if right modal has opened
           ...
           click_ele.click()
           #close the modal
           #driver.find_element_by_xpath("//*[@id='iob-package-adder-modal-close']")
           ...
           time.sleep(2)
           # SWITCH THE FRAME 
           driver.switch_to.frame(driver.find_element_by_xpath("//*[@class='package-tree-iframe']"))
           #driver.switch_to.frame(driver.find_element_by_xpath("//*[@ng-click='togglePackageTree(pkg)']"))
